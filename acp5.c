/*The code utilizes a high-level C language code, which attempts to control the turning on, off, and alternation of LED lights through input and output units of our board.*/
